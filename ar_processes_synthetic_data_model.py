...
from tcn import tcn
from artificial_data import generate_ar_processes
...
def main(noise, dropout_rate_tcn, dropout_rate_hidden, tol_default, length_vars, discard, encoder_type, batch_size, epochs, scaling_method, version):
    ...
    models_folder = '/scratch/jcalde2/Causation/SyntheticDataExamples/AR_Processes/'
    ...
    if version is None:
        ...
        model_parameters_['model'] = 'generate_ar_processes'
        ...
        model_parameters_['init_cond'] = []
        model_parameters_['var1'] = 0
        model_parameters_['var2'] = 1    
        model_parameters_['couplings'] = np.round(np.arange(0.0, 0.604, 0.05) + 1e-4, 4).tolist()
