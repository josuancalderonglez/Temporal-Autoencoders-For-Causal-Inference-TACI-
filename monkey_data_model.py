...
def main(noise, dropout_rate_tcn, dropout_rate_hidden, tol_default, seqs_len, 
         ...
         brain_area_key1, brain_area_key2, array_index, version):
    ...
    brain_area_1 = brain_area_keys[brain_area_key1]
    brain_area_2 = brain_area_keys[brain_area_key2]

    combinations = generate_combinations(brain_area, brain_area_1, brain_area_2)
    vv1, vv2 = combinations[array_index]

    variables = variables[:, [vv1, vv2]]
    ...
    directory = models_folder + 'Results/MainSession/' + brain_area_1 + '/' + brain_area_2 + '/' + \
                'chan_' + str(vv1) + '/' + 'chan_' + str(vv2) + '/'

    temporal_unidirectional(directory, variables, var1, var2, noise, dropout_rate_tcn, dropout_rate_hidden,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--brain_area_key1", type=int, required=True, help="First brain area key")
    parser.add_argument("--brain_area_key2", type=int, required=True, help="Second brain area key")
    ...
    main(args.noise, args.dropout_rate_tcn, args.dropout_rate_hidden, args.tol_default, 
         ...
         args.window_len, args.brain_area_key1, args.brain_area_key2, args.array_index, args.version)
