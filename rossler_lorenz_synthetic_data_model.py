...
from tcn import tcn
from artificial_data import generate_rossler_lorenz
...
def main(noise, dropout_rate_tcn, dropout_rate_hidden, tol_default, length_vars, discard, encoder_type, batch_size, epochs, scaling_method, version):
    ...
    models_folder = '/scratch/jcalde2/Causation/SyntheticDataExamples/Rossler_Lorenz/'
    ...
    if version is None:
        ...
        model_parameters_['model'] = 'generate_rossler_lorenz'
        ...
        model_parameters_['init_cond'] = [0,0,0.4,0.3,0.3,0.3]
        model_parameters_['var1'] = 1
        model_parameters_['var2'] = 4
        model_parameters_['couplings'] = np.round(np.arange(0.0, 5.51, 0.25) + 1e-4, 4).tolist()
