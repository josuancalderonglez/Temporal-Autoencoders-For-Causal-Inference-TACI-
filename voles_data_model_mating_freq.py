...
def main(noise, dropout_rate_tcn, dropout_rate_hidden, tol_default, seqs_len, 
    ...
    # Load Data    
    filename = models_folder + 'Data/Subset/mating_per_freq.pkl'
    ...
    directory = models_folder + 'Results/Mating/Frequency/Freq_' + str(array_index+1) + '/TCNI/Training/'

    window_lens = [10000000]
